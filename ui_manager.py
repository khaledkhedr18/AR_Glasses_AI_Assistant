...
from config import LABELS_WIDTH_PERCENT, CAMERA_WIDTH_PERCENT
...
class UIManager:
    def __init__(self, root, app_title="AR EyeConic", logo_path="logo.png"):
        ...
        self.root.configure(bg='black') # Ensure root background is black
        ...
        self.hide_labels() # Start with labels hidden
        print("UIManager initialized.")

    def _setup_styles(self):
        self.custom_font = ("Segoe UI", 12)
        self.title_font = ("Segoe UI Semibold", 14)
        # Calculate wrap_length based on screen width, ensure it's positive
...
if __name__ == '__main__':
    ...
    root_test = tk.Tk()
    ui = UIManager(root_test, logo_path="../logo.png") # Adjust path if testing from different dir
